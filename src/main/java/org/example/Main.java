...
//-------------------- Prestiti
        ...
        List<ElementoCatalogo> prestitiUtente3 = new ArrayList<>();
        ...
        prestitiUtente3.add(archivioDAO.getElemById(5));
        prestitiUtente3.add(archivioDAO.getElemById(6));
        ...
        Prestito prestito3 = new Prestito(archivioDAO.getUserById(3), prestitiUtente3, LocalDate.of(2025, 1, 2));
        Prestito prestito4 = new Prestito(archivioDAO.getUserById(3), prestitiUtente3, LocalDate.of(2023, 1, 2));
