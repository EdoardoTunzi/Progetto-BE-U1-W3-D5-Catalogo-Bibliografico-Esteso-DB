...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        archivioDAO.saveElemento(libro1);
        archivioDAO.saveElemento(libro2);
        archivioDAO.saveElemento(libro3);
        archivioDAO.saveElemento(libro4);
        archivioDAO.saveElemento(libro5);

        archivioDAO.saveElemento(rivista1);
        archivioDAO.saveElemento(rivista2);
        archivioDAO.saveElemento(rivista3);
        archivioDAO.saveElemento(rivista4);
        archivioDAO.saveElemento(rivista5);
        ...
        archivioDAO.savePrestito(prestito1);
